        ...
        <div className="flex items-center gap-1.5 mt-1.5">
          {task.completed ? (
            <>
              {task.checker && (
                <div className="rounded-full flex items-center justify-center text-white font-bold flex-shrink-0"
                  style={{ width: 16, height: 16, background: task.checker.color, fontSize: 7 }}>
                  {task.checker.name[0].toUpperCase()}
                </div>
              )}
            ...
            <>
              {task.profiles && (
                <div className="rounded-full flex items-center justify-center text-white font-bold flex-shrink-0"
                  style={{ width: 16, height: 16, background: task.profiles.color, fontSize: 7 }}>
                  {task.profiles.name[0].toUpperCase()}
                </div>
              )}
              <span className="text-[10px]" style={{ color: 'var(--text-subtle)' }}>
