...
import { ChevronLeft, ChevronRight, Plus, X, Check, Loader2, Clock } from 'lucide-react'
...
export default function CalendarPage() {
  ...
  const eventsOnDay = (d: Date) =>
    events.filter((e) => e.start_date === dateStr(d))
  ...
  return (
    <>
      <Header title="Календарь" subtitle={`${MONTHS[month]} ${year}`} />
      ...
      <main className="flex flex-col">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-7 gap-px px-2 pb-2" style={{ background: 'var(--border)' }}>
            {cells.map((d, i) => {
              if (!d) return (
                <div key={i} className="aspect-square" style={{ background: 'var(--bg)' }} />
              )
                ...
                >
                  <span
                    ...
                    style={{
                      ...
                      color: isToday ? '#fff' : isSelected ? 'var(--primary)' : 'var(--text)',
          ...
          <div className="flex items-center justify-between">
            <p className="text-sm font-semibold" style={{ color: 'var(--text)' }}>
              ...
              {isSameDay(selected, today) && (
                <span className="ml-2 text-xs font-normal" style={{ color: 'var(--primary)' }}>
                  сегодня
                </span>
              )}
            </p>
            ...
            <div className="p-5 flex flex-col gap-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  style={{ background: form.all_day ? 'var(--primary)' : 'var(--surface-3)' }}
                >
                  <span
